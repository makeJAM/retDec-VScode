...
```txt
RUN: C:\retdec\bin\retdec-fileinfo -c C:\retdec\calcDecom\retDecCalc.json --similarity --verbose C:\retdec\calcDecom\calc.exe --crypto C:\retdec\bin\..\share\retdec\support\generic\yara_patterns\signsrch\signsrch.yara --crypto C:\retdec\bin\..\share\retdec\support\generic\yara_patterns\signsrch\signsrch.yarac --crypto C:\retdec\bin\..\share\retdec\support\generic\yara_patterns\signsrch\signsrch_regex.yara --crypto C:\retdec\bin\..\share\retdec\support\generic\yara_patterns\signsrch\signsrch_regex.yarac
...
## Trying to unpack C:\retdec\calcDecom\calc.exe into C:\retdec\calcDecom\retDecCalc-unpacked.tmp by using generic unpacker...

___________

```txt
RUN: C:\retdec\bin\retdec-unpacker C:\retdec\calcDecom\calc.exe -o C:\retdec\calcDecom\retDecCalc-unpacked.tmp
No matching plugins found for 'VMProtect'
```
...
## Trying to unpack C:\retdec\calcDecom\calc.exe into C:\retdec\calcDecom\retDecCalc-unpacked.tmp by using UPX...

___________

```txt
RUN: upx -d C:\retdec\calcDecom\calc.exe -o C:\retdec\calcDecom\retDecCalc-unpacked.tmp
upx: invalid string 'C:\Users\jonma\Downloads\upx-3.95-win64\upx-3.95-win64\upx.exe' in environment variable 'UPX'
```
...
## Decompiling C:\retdec\calcDecom\calc.exe into C:\retdec\calcDecom\retDecCalc.bc...

___________

```txt
RUN: C:\retdec\bin\retdec-bin2llvmir -provider-init -decoder -verify -x87-fpu -main-detection -idioms-libgcc -inst-opt -cond-branch-opt -syscalls -stack -constants -param-return -local-vars -inst-opt -simple-types -generate-dsm -remove-asm-instrs -class-hierarchy -select-fncs -unreachable-funcs -inst-opt -x86-addr-spaces -value-protect -instcombine -tbaa -targetlibinfo -basicaa -domtree -simplifycfg -domtree -early-cse -lower-expect -targetlibinfo -tbaa -basicaa -globalopt -mem2reg -instcombine -simplifycfg -basiccg -domtree -early-cse -lazy-value-info -jump-threading -correlated-propagation -simplifycfg -instcombine -simplifycfg -reassociate -domtree -loops -loop-simplify -lcssa -loop-rotate -licm -lcssa -instcombine -scalar-evolution -loop-simplifycfg -loop-simplify -aa -loop-accesses -loop-load-elim -lcssa -indvars -loop-idiom -loop-deletion -memdep -gvn -memdep -sccp -instcombine -lazy-value-info -jump-threading -correlated-propagation -domtree -memdep -dse -dce -bdce -adce -die -simplifycfg -instcombine -strip-dead-prototypes -globaldce -constmerge -constprop -instnamer -domtree -instcombine -instcombine -tbaa -targetlibinfo -basicaa -domtree -simplifycfg -domtree -early-cse -lower-expect -targetlibinfo -tbaa -basicaa -globalopt -mem2reg -instcombine -simplifycfg -basiccg -domtree -early-cse -lazy-value-info -jump-threading -correlated-propagation -simplifycfg -instcombine -simplifycfg -reassociate -domtree -loops -loop-simplify -lcssa -loop-rotate -licm -lcssa -instcombine -scalar-evolution -loop-simplifycfg -loop-simplify -aa -loop-accesses -loop-load-elim -lcssa -indvars -loop-idiom -loop-deletion -memdep -gvn -memdep -sccp -instcombine -lazy-value-info -jump-threading -correlated-propagation -domtree -memdep -dse -dce -bdce -adce -die -simplifycfg -instcombine -strip-dead-prototypes -globaldce -constmerge -constprop -instnamer -domtree -instcombine -simple-types -stack-ptr-op-remove -inst-opt -idioms -global-to-local -dead-global-assign -instcombine -phi2seq -value-protect -disable-inlining -disable-simplify-libcalls -config-path C:\retdec\calcDecom\retDecCalc.json -o C:\retdec\calcDecom\retDecCalc.bc
Running phase: Initialization ( 0.00s )
Running phase: LLVM ( 0.01s )
Running phase: Providers initialization ( 0.01s )
Running phase: Input binary to LLVM IR decoding ( 0.58s )
Running phase: LLVM ( 0.60s )
Running phase: x87 fpu register analysis ( 0.60s )
Running phase: Main function identification optimization ( 0.60s )
Running phase: Libgcc idioms optimization ( 0.60s )
Running phase: LLVM instruction optimization ( 0.60s )
Running phase: Conditional branch optimization ( 0.61s )
Running phase: Syscalls optimization ( 0.61s )
Running phase: Stack optimization ( 0.61s )
Running phase: Constants optimization ( 0.62s )
Running phase: Function parameters and returns optimization ( 0.64s )
Running phase: Register localization optimization ( 0.65s )
Running phase: LLVM instruction optimization ( 0.65s )
Running phase: Simple types recovery optimization ( 0.65s )
Running phase: Disassembly generation ( 0.66s )
Running phase: Assembly mapping instruction removal ( 0.69s )
Running phase: C++ class hierarchy optimization ( 0.70s )
Running phase: Selected functions optimization ( 0.70s )
Running phase: Unreachable functions optimization ( 0.70s )
Running phase: LLVM instruction optimization ( 0.70s )
Running phase: x86 address spaces optimization ( 0.70s )
Running phase: Value protection optimization ( 0.70s )
Running phase: LLVM ( 0.70s )
Running phase: Simple types recovery optimization ( 1.05s )
Running phase: Stack pointer operations optimization ( 1.05s )
Running phase: LLVM instruction optimization ( 1.05s )
Running phase: Instruction idioms optimization ( 1.05s )
Running phase: Global to local optimization ( 1.05s )
Running phase: Dead global assign optimization ( 1.06s )
Running phase: LLVM ( 1.06s )
Running phase: Phi2Seq optimization ( 1.08s )
Running phase: Value protection optimization ( 1.08s )
Running phase: LLVM ( 1.08s )
Running phase: Bitcode Writer ( 1.08s )
Running phase: Assembly Writer ( 1.08s )
Running phase: Cleanup ( 1.10s )
```

## Decompiling C:\retdec\calcDecom\retDecCalc.bc into C:\retdec\calcDecom\retDecCalc...

```txt
RUN: C:\retdec\bin\retdec-llvmir2hll -target-hll=c -var-renamer=readable -var-name-gen=fruit -var-name-gen-prefix= -call-info-obtainer=optim -arithm-expr-evaluator=c -validate-module -o C:\retdec\calcDecom\retDecCalc C:\retdec\calcDecom\retDecCalc.bc -enable-debug -emit-debug-comments -config-path=C:\retdec\calcDecom\retDecCalc.json -emit-cg -emit-cfgs
```
...
Running phase: optimizations [normal] ( 0.04s )
```
...
```txt
 ...
 -> running UnusedGlobalVarOptimizer ( 0.04s )
 -> running DeadLocalAssignOptimizer ( 0.04s )
 -> running SimpleCopyPropagationOptimizer ( 0.05s )
 -> running CopyPropagationOptimizer ( 0.09s )
 -> running AuxiliaryVariablesOptimizer ( 0.17s )
 -> running SimplifyArithmExprOptimizer ( 0.19s )
 -> running IfStructureOptimizer ( 0.19s )
 -> running LoopLastContinueOptimizer ( 0.19s )
 -> running PreWhileTrueLoopConvOptimizer ( 0.19s )
 -> running WhileTrueToForLoopOptimizer ( 0.19s )
 -> running WhileTrueToWhileCondOptimizer ( 0.19s )
 -> running IfBeforeLoopOptimizer ( 0.19s )
 -> running LLVMIntrinsicsOptimizer ( 0.19s )
 -> running VoidReturnOptimizer ( 0.20s )
 -> running BreakContinueReturnOptimizer ( 0.20s )
 -> running BitShiftOptimizer ( 0.20s )
 -> running DerefAddressOptimizer ( 0.20s )
 -> running EmptyArrayToStringOptimizer ( 0.20s )
 -> running BitOpToLogOpOptimizer ( 0.20s )
 -> running SimplifyArithmExprOptimizer ( 0.20s )
 -> running UnusedGlobalVarOptimizer ( 0.20s )
 -> running DeadLocalAssignOptimizer ( 0.20s )
 -> running SimpleCopyPropagationOptimizer ( 0.20s )
 -> running CopyPropagationOptimizer ( 0.24s )
 -> running SelfAssignOptimizer ( 0.28s )
 -> running VarDefForLoopOptimizer ( 0.28s )
 -> running VarDefStmtOptimizer ( 0.28s )
 -> running EmptyStmtOptimizer ( 0.28s )
 -> running GotoStmtOptimizer ( 0.28s )
 -> running SimplifyArithmExprOptimizer ( 0.29s )
 -> running DeadCodeOptimizer ( 0.29s )
 -> running DerefToArrayIndexOptimizer ( 0.29s )
 -> running IfToSwitchOptimizer ( 0.29s )
 -> running CCastOptimizer ( 0.29s )
 -> running CArrayArgOptimizer ( 0.29s )
 ```

 ___________

```txt
Running phase: variable renaming [readable] ( 0.29s )
Running phase: converting constants to symbolic names ( 0.29s )
Running phase: module validation ( 0.29s )
```

___________

```txt
 -> running BreakOutsideLoopValidator ( 0.29s )
 -> running NoGlobalVarDefValidator ( 0.29s )
 -> running ReturnValidator ( 0.29s )
```

___________

```txt
Running phase: emission of control-flow graphs ( 0.29s )
Running phase: emission of a call graph ( 0.42s )
Running phase: emission of the target code [c] ( 0.43s )
Running phase: finalization ( 0.44s )
Running phase: cleanup ( 0.45s )
```
...
```txt
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cg.dot -o C:\retdec\calcDecom\retDecCalc.cg.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.entry_point.dot -o C:\retdec\calcDecom\retDecCalc.cfg.entry_point.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_40119c.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_40119c.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_40148b.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_40148b.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401512.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401512.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401513.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401513.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401680.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401680.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401799.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401799.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401820.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401820.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401890.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401890.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_4018c3.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_4018c3.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401a94.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401a94.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401ac5.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401ac5.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401b42.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401b42.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401b90.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401b90.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401b9e.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401b9e.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401ba4.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401ba4.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401c0e.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401c0e.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401c44.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401c44.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401c50.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401c50.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401c60.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401c60.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401cb0.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401cb0.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401d70.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401d70.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401da5.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401da5.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401db8.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401db8.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401dc0.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401dc0.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401e05.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401e05.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401e22.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401e22.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401e50.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401e50.png
RUN: dot -Tpng C:\retdec\calcDecom\retDecCalc.cfg.function_401e53.dot -o C:\retdec\calcDecom\retDecCalc.cfg.function_401e53.png
```
